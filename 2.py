...
# Specify the path to the ImageMagick convert.exe executable
convert_path = r"E:\\Learning\\Gradio\\GIF\\ImageMagick-7.1.1-Q16-HDRI\\convert.exe"
mpconfig.change_settings({"IMAGEMAGICK_BINARY": convert_path})
